...
X_train, X_test, y_train, y_test = train_test_split(X, y, random_state = 91, test_size = 0.25)
# injectGaussianNoise(X_train, ["perimeter3"], 0, X_train["perimeter3"].std()**2)

clf = DecisionTreeClassifier(criterion = "gini", random_state = 91, max_depth = 4, min_samples_leaf = 5)
